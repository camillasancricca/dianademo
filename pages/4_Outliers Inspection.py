...
from explainability.explainations import get_explanation_outliers
...
with st.expander("More Details on Possible Outliers"):
    exp1, exp2 = get_explanation_outliers(df)
    st.write(exp1)
    st.write(exp2)
